    ...
    <section className="section">
      <div className="grid md:grid-cols-3 gap-8 items-start">
        <div className="md:col-span-2 space-y-4">
          ...
          <p className="text-white">I specialize in front-end and back-end development, with a strong focus on technologies like React, Vite, TailwindCSS, and serverless backends deployed on Vercel. My projects are not just about writing code — they are about delivering functional, scalable, and visually engaging products that solve real-world problems. Whether I am building a corporate website, an e-commerce platform, or an educational portal, I ensure every detail aligns with best practices in performance, security, and user experience.</p>
        ...
        <div className="card">
          ...
          <ul className="text-gray space-y-2 list-disc list-inside">
            ...
            <li>Backend: Vercel Serverless APIs</li>
